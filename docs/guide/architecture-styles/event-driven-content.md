...
- Business processes in event-driven architectures consist of many events within the system. [Workflow patterns](https://docs.particular.net/architecture/workflows/) help to reliably coordinate message flows across various services.
